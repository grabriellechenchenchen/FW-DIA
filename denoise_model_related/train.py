...
# =============================================================================  
    ...
    y_true = test_labels
    y_pred = np.where(predict_x >0.2,1,0)
    ...
    #plt.savefig(pic_save_path + "/roc1.png")
    #plt.show()
    ...
    plt.legend(loc="lower right")
    #plt.savefig(pic_save_path + "/precisin_recall1.png")
    #plt.show()    

    #TPR_TNR_rate(y_true, predict_x)
...
def TPR_TNR_rate(y_true, predict_x):
...
def train_start(seed, learning_rate, drop_rate, decay_rate, decay_steps):
    ...
    default_model_path = "D:/gitclone/denoise/data/model/"+folder_name+"/"
    if not os.path.exists(default_model_path):
        os.mkdir(default_model_path)

    test_loss, test_accuracy = train_model1(train_data="D:/gitclone/denoise/data/train/traindata_1_2_3_4_5_6_7_13.csv",
                 saveModel_path = "D:/gitclone/denoise/data/model/"+folder_name + "/"+save_model_name+".keras",
                 saveScaler_path = "D:/gitclone/denoise/data/model/"+folder_name + "/"+save_scaler_name +".pkl",
                 pic_save_path = "D:/gitclone/denoise/data/model/"+folder_name,
                 seed=seed, drop_rate=drop_rate, learning_rate_value = learning_rate, decay_rate = decay_rate, decay_steps = decay_steps)
    
    #valiation set
    val_acc = roc_precision_recall_plot(model_path = "D:/gitclone/denoise/data/model/"+folder_name + "/"+save_model_name+".keras", 
                  test_data = "D:/gitclone/denoise/data/train/validation_hetangti.csv", 
                  scaler_path = "D:/gitclone/denoise/data/model/"+folder_name + "/"+save_scaler_name +".pkl",
                  pic_save_path = "D:/gitclone/denoise/data/model/"+folder_name)
...
#train_data_visualize(train_data="D:/gitclone/denoise/data/train/traindata_1_2_3_4_5_6_7_13.csv")
...
decay_rate_list = [0.9, 0.92, 0.94, 0.96, 0.98]
        ...
        for drop_rate in drop_out_list:
            for decay_rate in decay_rate_list:
                for decay_steps in decay_steps_list:
                        ...
                        df.to_csv('D:/gitclone/denoise/data/model/model_training_result_temp.csv', index=False, mode='a')
                        

df = pd.DataFrame(results)
df.to_csv('D:/gitclone/denoise/data/model/model_training_results_final.csv', index=False, mode='a')
''' 
...
#predict_model(model_path = "D:/gitclone/denoise/data/model/model_3and5and1and4.keras", test_data = "D:/gitclone/denoise/data/train/test.csv")
#predict_model(model_path = "D:/gitclone/denoise/data/model/model_3and5and1and4.keras", test_data = "D:/gitclone/denoise/data/train/test_hetangti.csv")
