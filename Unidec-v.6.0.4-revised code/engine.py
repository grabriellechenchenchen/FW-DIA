...
class UniDec(UniDecEngine):
    ...
    def run_unidec(self, silent=False, efficiency=False):
        ...
        if not silent:
            print("//////////////////unidec-engine sc run %.2gs" % self.config.runtime)
    ...
    def setup_peaks(self, peaks):
        ...
        try:
            ...
            #print("engine.py make peaks mztab")
        except Exception:
            mztab = []
            pass
        ...
        if self.config.batchflag == 0:
            try:
                ...
                #print("ud.make_peaks_mztab_spectrum")
                self.export_config()
            except Exception:
                pass
...
if __name__ == "__main__":
    ...
    eng.export_params(e=None, silent=False)
